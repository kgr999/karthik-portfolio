...
const SocialLivePreview = lazy(() => import('./components/SocialLivePreview'));
...
export default function App() {
    ...
    }, [isInitialized, isMobile, isRiderOpen, isMobileMenuOpen]);
                    ...
                    <section id="contact" style={{ position: 'relative', overflow: 'hidden' }}>
                        ...
                        <div className="container" style={{ position: 'relative', zIndex: 2, pointerEvents: 'none' }}>
                            ...
                            <div className="contact-center-group">
                                ...
                                {/* Backstage Studio ID Badges (Replacing simple dock) */}
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '860px', margin: '0 auto' }}>
                                    <div className="social-dock-title reveal-text" style={{ marginBottom: '16px' }}>
                                        Let's Connect
                                    </div>
                                    <div style={{ position: 'relative', zIndex: 5, pointerEvents: 'auto', width: '100%' }}>
                                        <Suspense fallback={null}>
                                            <SocialLivePreview />
                                        </Suspense>
                                    </div>
